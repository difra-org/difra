...
class Events {
	...
	private $types = array(
		// инициализация
		'whoami',	// определение окружения
		'config-stage1', // базовые настройки (база, кеш и т.д.)
		'init-php',	// настройка пхп
		'init-paths',	// настройка путей
		'init-core',	// загрузка нужных классов
		'plugins-load',	// загрузка плагинов
		'config-stage2',// загрузка полных настроек
