			...
			<table class="form">
				...
				<tbody>
					<tr>
						<th>
							<label for="spaceAfterShortWord">
								<xsl:value-of
									select="$locale/adm/typograph/spaceAfterShortWord"/>
							</label>
						</th>
						<td>
							<input type="checkbox" name="spaceAfterShortWord"
							       id="spaceAfterShortWord">
					...
					<tr>
						...
						<td>
							<input type="number" name="lengthShortWord"
							       value="{@lengthShortWord}"/>
						</td>
					</tr>
					<tr>
						<th>
							<label for="spaceBeforeLastWord">
								<xsl:value-of
									select="$locale/adm/typograph/spaceBeforeLastWord"/>
							</label>
						</th>
						<td>
							<input type="checkbox" name="spaceBeforeLastWord"
							       id="spaceBeforeLastWord">
					...
					<tr>
						...
						<td>
							<input type="number" name="lengthLastWord" id="lengthLastWord"
							       value="{@lengthLastWord}"/>
						</td>
					</tr>
					<tr>
						<th>
							<label for="spaceAfterNum">
								<xsl:value-of
									select="$locale/adm/typograph/spaceAfterNum"/>
							</label>
						</th>
						<td>
					...
					<tr>
						<th>
							<label for="spaceBeforeParticles">
								<xsl:value-of
									select="$locale/adm/typograph/spaceBeforeParticles"/>
							</label>
						</th>
						<td>
							<input type="checkbox" name="spaceBeforeParticles"
							       id="spaceBeforeParticles">
					...
					<tr>
						<th>
							<label for="delRepeatSpace">
								<xsl:value-of
									select="$locale/adm/typograph/delRepeatSpace"/>
							</label>
						</th>
						<td>
							<input type="checkbox" name="delRepeatSpace"
							       id="delRepeatSpace">
					...
					<tr>
						<th>
							<label for="delSpaceBeforePunctuation">
								<xsl:value-of
									select="$locale/adm/typograph/delSpaceBeforePunctuation"/>
							</label>
						</th>
						<td>
							<input type="checkbox" name="delSpaceBeforePunctuation"
							       id="delSpaceBeforePunctuation">
					...
					<tr>
						<th>
							<label for="delSpaceBeforeProcent">
								<xsl:value-of
									select="$locale/adm/typograph/delSpaceBeforeProcent"/>
							</label>
						</th>
						<td>
							<input type="checkbox" name="delSpaceBeforeProcent"
							       id="delSpaceBeforeProcent">
