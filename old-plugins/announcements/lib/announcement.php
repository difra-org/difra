...
Class Announcement
{
	...
	private function saveDescription()
	{
		...
		if ($this->description instanceof \Difra\Param\AjaxHTML or
			$this->description instanceof \Difra\Param\AjaxSafeHTML
		) {
	...
	public function getHumanizedTitle()
	{
		...
		if ($this->fromEventDate != '0000-00-00 00:00:00' &&
			$this->fromEventDate != '' &&
	...
	public function getHumanizedDate()
	{
		...
		if ($this->fromEventDate != '' &&
			$this->fromEventDate != '0000-00-00 00:00:00' &&
			$this->fromEventDate != $this->eventDate
		) {
