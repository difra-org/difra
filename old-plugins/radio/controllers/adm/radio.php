...
class AdmRadioController extends Difra\Controller
{
	...
	public function savechannelsettingsAjaxAction(
		Param\AnyString $channelName,
		...
		$dataArray = [
			...
			'reencode' => $reencode->val(),
			'debug' => $debug->val(),
			'onLine' => $onLine->val(),
			'minSongInQuery' => $minSongInQuery->val(),
			'minArtistInQuery' => $minArtistInQuery->val(),
			'tracksCount' => $tracksCount->val()
		];
	...
	public function settracksettingsAjaxAction(
		Param\AnyString $channelName,
		Param\AnyInt $trackId,
		Param\AjaxString $weight
	) {
	...
	public function createchannelAjaxAction(
		Param\AjaxString $name,
		Param\AjaxString $mount,
		Param\AjaxString $siteDescription = null,
		Param\AjaxString $description = null,
