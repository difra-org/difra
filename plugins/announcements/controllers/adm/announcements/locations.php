...
class AdmAnnouncementsLocationsController extends Difra\Controller {
	...
	public function saveAction( \Difra\Param\AjaxString $name, \Difra\Param\AjaxString $url = null,
				    \Difra\Param\AjaxString $address = null, \Difra\Param\AjaxString $phone = null,
				    \Difra\Param\AjaxString $info = null, \Difra\Param\AjaxInt $id = null ) {
		...
		$dataArray = array( 'name' => $name->val(), 'url' => $url, 'address' => $address, 'phone' => $phone, 'info' => $info );
