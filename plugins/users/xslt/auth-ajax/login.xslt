...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" version="1.0">
	<xsl:template match="/root/login">
		<div id="login">
			<form action="/auth/login" class="ajaxer">
				<h2><xsl:value-of select="$locale/auth/forms/loginTitle"/></h2>
				<div class="container">
					<input type="text"
					       name="email"
				...
				<div id="remember_me">
					...
					<label for="rememberMe"><xsl:value-of select="$locale/auth/forms/rememberMe"/></label>
				</div>
