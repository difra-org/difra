...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" version="1.0">
	<xsl:template match="/root/recover">
		<div id="recover">
			<form action="/auth/recover" class="ajaxer">
				<h2 id="recovery_title"><xsl:value-of select="$locale/auth/forms/recoverPasswordTitle"/></h2>
				<div class="container">
					<div class="holder">
						<input type="text"
						       name="email"
